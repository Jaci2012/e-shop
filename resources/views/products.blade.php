                                ...
                                <li>
                                    <a href="#" data-toggle="modal" data-target="#cartModal">
                                        <i class="fa fa-shopping-cart"></i> Cart <span
                                            id="cart-count">{{ Cart::getContent()->count() }}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li><a href="{{ route('front')}}" class="">Acceuil</a></li>
                                <li><a href="{{ route('all.products')}}" class="active">Produits</a></li>
                                <!-- Modal du panier -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer d-flex">
                                                <a type="button" class="btn btn-primary">Payement</a>
                                            </div>
                ...
                <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img src="" id="modalImage" class="img-fluid" alt="Image du produit"
                                    width="150px">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="{{ asset('storage/' . $product->image) }}" alt="Image du produit" width="100" data-toggle="modal" data-target="#imageModal" data-src="{{ asset('storage/' . $product->image) }}">
                                                <h2>{{ $product->prixUnit }}
                                                    {{ $product->devise
                                                        ? ($product->devise->name == 'Ariary' ? 'Ar' : ($product->devise->name == 'Euro' ? '€' : ($product->devise->name == 'Dollars' ? '$' : $product->devise->name)))
                                                        : 'Pas de devise' }}
                                                </h2>
                                                <p>{{ $product->name }}</p>
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data && Array.isArray(data.items)) {
                            ...
                            $('#cart-message').html(
                                '<div class="alert alert-danger">Erreur lors de la récupération des articles du panier.</div>'
                                );
                        }
                    },
                    error: function() {
            ...
            $('.add-to-cart').click(function(e) {
                ...
                var quantity = 1; // Vous pouvez également permettre à l'utilisateur de choisir la quantité
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            $('#cart-message').html('<div class="alert alert-success">' +
                                response.success + '</div>');
                            updateCartCount();
                            updateCartItems();
                        } else {
                            $('#cart-message').html('<div class="alert alert-danger">' +
                                response.error + '</div>');
                        }
                    },
                    error: function() {
                        $('#cart-message').html(
                            '<div class="alert alert-danger">Erreur lors de l\'ajout au panier.</div>'
                            );
                    }
                });
            });

            // Charger les articles du panier à l'ouverture du modal
            ...
            $(document).on('click', '.modify-quantity', function(e) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        $('#cart-message').html(
                            '<div class="alert alert-danger">Erreur lors de la modification de la quantité.</div>'
                            );
                    }
                });
            });
